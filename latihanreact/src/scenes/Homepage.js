	...
	const listPricing = [
		{
			...
			features: [
				{isChecked: true, content: "Exceptur sint lorem ipsum"},
				{isChecked: true, content: "Exceptur sint lorem ipsum"},
				{isChecked: true, content: "Exceptur sint lorem ipsum"},
				{isChecked: false, content: "Exceptur sint lorem ipsum"},
				{isChecked: false, content: "Exceptur sint lorem ipsum"}
			]
		},{
			price: 47,
									...
									listPricing.map((list, index) => (<Card hasShadow>
										<div className="pricing-item-content">
											...
											<div className="pricing-item-features mb-40">
												...
												<Lists data={list.features} className="pricing-item-features-list mb-32"></Lists>
												</div>
											</div>
